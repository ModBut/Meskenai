console.log("Welcome to loops.ls. Have Fun!");
...
} // naudojamas kai zinome kiek ciklu reikes daryti

let coin;
do {
  coin = rand(0, 1) ? "Head" : "Tails";
...
//kada ciklas gali neapsisuk neiviena karta
