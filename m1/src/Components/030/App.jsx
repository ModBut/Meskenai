...
export default function App() {
  ...
  const handleCheckbox = e => {
    setCheckboxes(prev => ({...prev, [e.target.name]: e.target.name }));
  }
    ...
    <div className="App">
      <header className="App-header" style={{backgroundColor}}>
        ...
        <div className="form">
          ...
          <input type='text' name='animal2' placeholder="Animal 2" value={multiText.animal1} onChange={handleMultiText}/>
          <input type='text' name='animal3' placeholder="Animal 3" value={multiText.animal1} onChange={handleMultiText}/>
          ...
          <div className="checkboxes">
              <input type='checkbox' id='A' checked={checkboxes.A} onChange={handleCheckbox}/>
              <label htmlFor='A'>A</label>
              <input type='checkbox' id='B' checked={checkboxes.B} onChange={handleCheckbox}/>
              <label htmlFor='B'>B</label>
              <input type='checkbox' id='C' checked={checkboxes.C} onChange={handleCheckbox}/>
              <label htmlFor='C'>C</label>
              <input type='checkbox' id='D' checked={checkboxes.D} onChange={handleCheckbox}/>
          ...
          <div className="radios">
              ...
              <input type='checkbox'id='Br' name='B' checked={radios.A} onChange={handleRadio}/>
              <label htmlFor='Br'>B</label>
              <input type='checkbox'id='Cr' name='C' checked={radios.A} onChange={handleRadio}/>
              <label htmlFor='Cr'>C</label>
              <input type='checkbox'id='Dr' name='D' checked={radios.A} onChange={handleRadio}/>
          ...
          <input type='number' min='0' max='255' value={rangeSetter} onChange={handleRangeSetter}/>
