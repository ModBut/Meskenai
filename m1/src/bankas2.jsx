...
function App() {
  ...
  useEffect(() => {
    setAccountBalance(accounts?.find(account => account.id === editBalance)?.account || 0);
  }, [editBalance, setAccountBalance, accounts])
                ...
                {sortedAccounts && sortedAccounts.length !== 0 && sortedAccounts
                    ...
                    <ul className="list-group list-group">
                      <div key={account.id}> 
                        ...
                        <div className="list-group-item">Sąskaitos likutis: {account.accountBalance}</div>
                        <Edit show={showEditModal} handleClose={handleClose} setUpdateAccount={setUpdateAccount} setAccountBalance={setAccountBalance}
                        accountBalance={accountBalance}/>
                        <div className="delete-button">
                        <button onClick={() => setShowEditModal(true)} className='button-lina'>Koreguoti sąskaitos likutį</button>
